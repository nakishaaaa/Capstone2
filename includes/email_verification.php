...
/**
 * Send email verification email for admin-created accounts
 * @param string $email User's email address
 * @param string $username User's username
 * @param string $token Verification token
 * @param string $role User's role (admin, cashier, user)
 * @param string $createdBy Admin who created the account
 * @return bool True if email sent successfully, false otherwise
 */
function sendAdminCreatedAccountVerificationEmail($email, $username, $token, $role, $createdBy) {
    try {
        $mail = require __DIR__ . "/mailer.php";
        
        $mail->setFrom("053printsaturservice@gmail.com", "053 Prints");
        $mail->addAddress($email, $username);
        $mail->Subject = "Account Created - Verify Your Email Address - 053 Prints";
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>053 PRINTS</h1>
                    <div class="subtitle">Account Created - Email Verification</div>
                </div>
                <div class="content">
                    <div class="greeting">Dear $username,</div>
                    
                    <div class="message">
                        An account has been created for you at 053 Prints by $createdBy. To activate your account and start using our printing services, please verify your email address.
                    </div>
                    ...
                    <div class="disclaimer">
                        <strong>Important:</strong> You must verify your email address before you can log in to your account. If you have any questions, please contact your administrator.
                    </div>
        ...
        error_log("Admin-created account verification email error: " . $e->getMessage());
        return false;
    }
}
