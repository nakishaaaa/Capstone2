...
function displayProductManagementTable(data) {
    ...
    if (!data || data.length === 0) {
        tableBody.innerHTML = '<tr><td colspan="8" style="text-align: center; padding: 2rem;">No products available. Click "Add Product" to create your first product.</td></tr>';
        return;
    }
                ...
                <div class="modal-body">
                    <div class="product-info-section" style="margin-bottom: 2rem; padding: 1rem; background: #f8f9fa; border-radius: 8px;">
                        ...
                        <div style="display: grid; grid-template-columns: auto 1fr; gap: 0.5rem 1rem;">
                            ...
                            <strong>Price:</strong> <span>₱${parseFloat(product.price).toFixed(2)}</span>
...
// CREATE NEW PRODUCT FUNCTION - Handles form submission and API call
